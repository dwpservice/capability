...
//  useEffect(()=>{ getData()},[]); 
 ...
 useEffect(() => {
    fetch("https://docs.google.com/spreadsheets/d/1ghhnt4HNV5OanZnay1H6w1-sA7wWkqQvwkijnhsQWo4/gviz/tq?key=AIzaSyDydZSlBGAle16E3K2r_0lw2NBoMOuMpwo")
      .then(resp => resp.text())
      .then(data => {
                         ...
                         temp1.forEach((item,index2,arr2)=>{
                            ...
                            switch (index2) {
                                ...
                                case 6:
                                    ...
                                    break; 
                                case 7:
                                    typeof item === 'undefined' || item === null ? strRow = strRow + `"overall" : "",` : strRow = strRow + `"overall" : "${arr2[index2].v}",`;
                                    break; 
                                case 8:
                                    typeof item === 'undefined' || item === null ? strRow = strRow + `"expect" : "",` : strRow = strRow + `"expect" : "${arr2[index2].v}",`;
                                    break;  
                                case 9:
                                    typeof item === 'undefined' || item === null ? strRow = strRow + `"actual" : "",` : strRow = strRow + `"actual" : "${arr2[index2].v}",`;
                                    break;                 
                                case 10:
...
//  const xxy = (myreceiveemail == 'sayampol.c@dwp.com'? [1,2,3]:[8,9,10])
 // console.log('katang myreceiveemail ',myreceiveemail)

  const superUsers = ['sumitr.p@dwp.com','sayampol.c@dwp.com', 'michael.h@dwp.com' , 'brenton.m@dwp.com' , 'scott.w@dwp.com' , 'geoff.m@dwp.com' , 'david.r@dwp.com' , 'angus.r@dwp.com' , 'ian.t@dwp.com' , 'sarinrath.k@dwp.com']
  let hiddenFlag = superUsers.indexOf(myreceiveemail)
 // console.log('HIDDENFLAG is ', hiddenFlag)
  const columns =  [
        {title:"Photo", field:"avata", render: rowData => <CardMedia component="img" src={rowData.avata}    name={rowData === undefined ? " " : rowData.name}   /> , editable: 'never'},
        ...
        {title:"Portfolio", field:"portfolio",lookup:{0:"Community",1:"Lifestyle",2:"Workplace"},hidden:true},
        {title:"Sector", field:"sector",lookup:{0:"Hospitality",1:"F&B",2:"Residential",3:"Seniors Living",4:"Retail",5:"Worksplaces",6:"Health",7:"Education",8:"Sport & Leisure",9:"Civic"},hidden:true}, 
        {title:"Email", field:"email"},
        {title:"Job Title", field:"JobTitle"},

        {title:"Overall Competency", field:"overall",lookup:{0:"Poor Performance",1:"Below Expectations",2:"Meet Expectations",3:"Highly Competent",4:"Top Performer"},headerStyle:{backgroundColor:"#00b33c",color:"white"},hidden:(hiddenFlag == -1 ) ? true : false}, 
        {title:"Expected Job Impact on Company", field:"expect",lookup:{0:"Negative Impact",1:"No Impact",2:"Expected Impact",3:"Influential",4:"High Impact"},headerStyle:{backgroundColor:"#00b33c",color:"white"},hidden:(hiddenFlag == -1 ) ? true : false},  
        {title:"Actual Company Impact", field:"actual",lookup:{0:"Negative Impact",1:"No Impact",2:"Expected Impact",3:"Influential",4:"High Impact"},headerStyle:{backgroundColor:"#00b33c",color:"white"},hidden:(hiddenFlag == -1 ) ? true : false},  
        ...
        {title:"Hospitality Exp Level", field:"expLevHos", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}},
        {title:"Hospitality Exp Work Type", field:"expWorHos", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}}, 
        {title:"F&B Exp Level", field:"expLevFnB", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}},
        {title:"F&B Exp Work Type", field:"expWorFnB", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}}, 
        {title:"Residential Exp Level", field:"expLevRes", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}},
        {title:"Residential Exp Work Type", field:"expWorRes", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}},  
        {title:"Seniors Living Exp Level", field:"expLevSen", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}},
        {title:"Seniors Living Exp Work Type", field:"expWorSen", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}}, 
        {title:"Retail Exp Level", field:"expLevRet", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}},
        {title:"Retail Exp Work Type", field:"expWorRet", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 2 ? false:true),headerStyle:{backgroundColor:"#ffb3ff",color:"white"}},  

        {title:"Workplaces Exp Level", field:"expLevWor", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 3 ? false:true),headerStyle:{backgroundColor:"#9966ff",color:"white"}},
        {title:"Workplaces Exp Work Type", field:"expWorWor", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 3 ? false:true),headerStyle:{backgroundColor:"#9966ff",color:"white"}},  

        {title:"Health Exp Level", field:"expLevHea", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 4 ? false:true),headerStyle:{backgroundColor:"#ffcc66",color:"white"}},
        {title:"Health Exp Work Type", field:"expWorHea", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 4 ? false:true),headerStyle:{backgroundColor:"#ffcc66",color:"white"}}, 
        {title:"Education Exp Level", field:"expLevEdu", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 4 ? false:true),headerStyle:{backgroundColor:"#ffcc66",color:"white"}},
        {title:"Education Exp Work Type", field:"expWorEdu", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 4 ? false:true),headerStyle:{backgroundColor:"#ffcc66",color:"white"}}, 
        {title:"Sport & Leisure Exp Level", field:"expLevSpo", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 4 ? false:true),headerStyle:{backgroundColor:"#ffcc66",color:"white"}},
        {title:"Sport & Leisure Exp Work Type", field:"expWorSpo", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 4 ? false:true),headerStyle:{backgroundColor:"#ffcc66",color:"white"}},  
        {title:"Civic Exp Level", field:"expLivCiv", lookup:{0:"No Experience",1:"Entry Level",2: "Moderate",3: "Proficient",4:"Expert"},hidden:(currentStep === 4 ? false:true),headerStyle:{backgroundColor:"#ffcc66",color:"white"}},
        {title:"Civic Exp Work Type", field:"expWorCiv", lookup:{0:"No Experience",1:"Observation",2: "Documentation",3: "Design",4:"Project Leader"},hidden:(currentStep === 4 ? false:true),headerStyle:{backgroundColor:"#ffcc66",color:"white"}}
    ]
    ...
    <div className="App">
         ...
         <MaterialTable 
            ...
            actions={[
                { icon: ()=><Button variant='contained' startIcon={<StorageIcon />}  >Save To Database</Button>,
                    tooltip: "Warning! after you finish modifying data please press this button only once before you leave the program to save all your changes to database otherwise, your changes will be ignored...",
                    onClick: (data)=> {
                ...
                /*        console.log("SAYAMPOL ",mybearer);    */
                        ...
                        for (var i = 0;i < modifiedData.length; i++){
                            ...
                            innerArray.push(typeof modifiedData[i].overall === 'undefined' || modifiedData[i].overall === "" ? "" : modifiedData[i].overall) 
                            innerArray.push(typeof modifiedData[i].expect === 'undefined' || modifiedData[i].expect === "" ? "" : modifiedData[i].expect)  
                            innerArray.push(typeof modifiedData[i].actual === 'undefined' || modifiedData[i].actual === "" ? "" : modifiedData[i].actual)
                            ...
                            innerArray.push(typeof modifiedData[i].projectMan === 'undefined' || modifiedData[i].projectMan === "" || modifiedData[i].projectMan === "null" ? "" : modifiedData[i].projectMan)
                    ...
                    //    console.log('OutterArray is ',outterArray) 
                        ...
                        var config = {
                           method: 'post',
                           url: `https://sheets.googleapis.com/v4/spreadsheets/1ghhnt4HNV5OanZnay1H6w1-sA7wWkqQvwkijnhsQWo4/values/Sheet1!A2:AV200:clear?access_token=${mybearer}`,
                           headers: {}
                        };
                        ...
                        /*    console.log('dataRange => ',dataRange)  */
                            var configAppend = {
                                method: 'post',
                                url: 'https://sheets.googleapis.com/v4/spreadsheets/1ghhnt4HNV5OanZnay1H6w1-sA7wWkqQvwkijnhsQWo4/values/Sheet1!A2:AV200:append?valueInputOption=USER_ENTERED',
                                headers: {
            ...
            title="Capability and skills matrix (beta version)" 
            icons={{Add:()=><AddIcon />}}
     ...
     <Snackbar open={open} autoHideDuration={3000} onClose={handleClose} anchorOrigin={{vertical,horizontal}}>
            <Alert onClose={handleClose} severity="success" sx={{ width: '100%' }}>
                Save changes to database completed!
            </Alert>
     </Snackbar> 
    </div>
  );
